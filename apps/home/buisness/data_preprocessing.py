...
def make_all_process():
    df = pd.read_csv(
        '/home/nimaasltoghiri/Documents/Django/charts/black-dashboard-django-master/apps/home/data/new_price.csv',
        header=None)
    ...
    df_event = pd.read_csv(
        "/home/nimaasltoghiri/Documents/Django/charts/black-dashboard-django-master/apps/home/data/events_date_bamland.csv",
        header=None)
