...
filename_count = '/home/nimaasltoghiri/Documents/Django/charts/black-dashboard-django-master/apps/home/buisness/models/count_model.pkl'
filename_sale = '/home/nimaasltoghiri/Documents/Django/charts/black-dashboard-django-master/apps/home/buisness/models/sale_model.pkl'
...
def predict_sales(days):
    ...
    Returns خروجی این تابع آرایه ای از پیشبینی ها میباشد.
    -------
...
def last_year(df=make_all_process(), start_date=None, end_date=None):
    ...
    df_6m = df[(df['date'] >= str(start_ly)) & (df['date'] < str(end_ly))]
    sale_6m_sum = df_6m[['month', 'total_price']].groupby(df_6m['month']).sum()['total_price']/10
