...
from .buisness.buisness import before_data, predict_next_n_month, predict_sales, previous_n_month, \
    previous_six_month_improve, last_year
...
improvements, improvements_mean = list(previous_six_month_improve())
...
def index(request):
    ...
    context = {'segment': 'index', 'values_month': predictions_month, 'labels_month': list_dates_month,
               ...
               'improvements': improvements, 'improvements_mean': improvements_mean,
